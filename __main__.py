    ...
    def play_game(self):
        try:
            ...
            if self.game_field[self.x, self.y] == 1:
                ...
                print(X_FIELD)
                print(
                    f'There are {9 - np.count_nonzero(self.game_field)} blocks left to be mined'
                )
            ...
            print(
                "Incorrect coordinates.The field is square and there are 9 blocks on it. Try again"
            )
            self.play_game()
